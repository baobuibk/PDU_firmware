...
typedef enum channel_status {OFF = 0, READY, OVERVOLTAGE, OVERCURRENT, ON} channel_status;
	
typedef enum e_PDU_Status {POWERUP, RUNNING, OVERVALUE, SHUTDOWN} e_PDU_Status;
