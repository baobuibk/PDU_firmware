...
extern const uint8_t channel_mapping_to_buck[POWER_OUTPUT];
extern const uint8_t buck_mapping_to_channel[2][NUM_OF_BUCK];
extern const uint8_t buck_mapping_to_time[2][NUM_OF_BUCK];
extern const uint8_t time_mapping_to_channel[POWER_OUTPUT];
extern const  char NAME_TABLE[POWERIO_CHANNEL][12];
extern const NAME_OF_STATUS NAME_STATUS_TABLE[5];
extern uint16_t OFF_TIME_MAXIMUM[POWER_OUTPUT];
extern const uint8_t time_mapping_to_cmd[POWER_OUTPUT];
extern volatile uint16_t OFF_TIME[POWER_OUTPUT];
extern e_PDU_Status PDU_Status;
void POWER_IO_init();
