...
// Commands
#define FSP_CMD_RESPONSE_DONE		0		/*response ascii*/
#define FSP_CMD_PDU_SET_CHANNEL		1       /*set on/off channel*/
#define FSP_CMD_PDU_SET_BUCK		2       /*set on/off buck*/
#define FSP_CMD_PDU_SET_ALL			3       /*set on/off all power*/
#define FSP_CMD_PDU_GET_CHANNEL		4       /*get parameter of channel*/
#define FSP_CMD_PDU_GET_BUCK		5       /*get parameter of buck*/
#define FSP_CMD_PDU_GET_ALL			6		/*get parameter all buck*/
...
#define FSP_PKT_MAX_LENGTH              128     /**< Maximum packet length in bytes. */
#define FSP_PAYLOAD_MAX_LENGTH          121     /**< Maximum packet payload length in bytes. */
