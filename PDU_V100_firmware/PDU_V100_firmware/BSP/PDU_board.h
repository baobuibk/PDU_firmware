...
#define PDU_INT_PINR		PIND
#define PDU_INT_DDR			DDRD
#define PDU_INT_PIN			PIND5

/*******************************/

/***********POWER_GOOD**********/
#define PDU_POWERGOOD_PORT	PORTB
#define PDU_POWERGOOD_DDR	DDRB
#define PDU_POWERGOOD_PIN	PINB5
/*******************************/
...
#define VREF				(float)4.096
#define ADC_2V				(uint16_t)((float)((2*1024/VREF) / 2) + 10)
#define ADC_5V				(uint16_t)((float)((5*1024/VREF) / 2) + 10)
#define ADC_25V				(uint16_t)((float)((25*1024/VREF) / 11) + 10)
#define ADC_32V				(uint16_t)((float)(2.9*1024/VREF) + 10)
#define ADC_17V				(uint16_t)((float)((17*1024/VREF) / 11) + 10)
#define ADC_12V				(uint16_t)((float)((12*1024/VREF) / 11) + 10)
#define	ADC_VBUS			(uint16_t)((float)((14.4*1024/VREF) / 11) + 10)
#define ADC_1A				(uint16_t)285 + 10
#define ADC_2A				(uint16_t)570 + 10
#define ADC_2A5				(float)712 + 10

#define SCALE_5V			(float)(VREF*2/1024)
#define SCALE_12V			(float)(VREF*11/1024)
#define SCALE_VBUS			(float)(VREF*11/1024)
#define SCALE_A				(float)(VREF/(1.1*1024))
//#define SCALE_A				(float)(3/1024)
#define ANALOG_CHANNEL		19
#define	MUX_WAIT_FOR_STABLE 3
#define POWERIO_CHANNEL		19
#define POWER_OUTPUT		9
#define MCU_MAXIMUM_TIME_OFF 5000
#endif
